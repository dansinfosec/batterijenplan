...
- Discarded the earlier short repositioning (~400 words) — it would have removed valuable production content.
- Reconciled manifest now PRESERVES the full production body (~1257 words) + adds 4 internal links.
